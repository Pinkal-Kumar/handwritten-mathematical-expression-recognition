...
class CAN(nn.Module):
    def __init__(self, params=None):
        ...
        #self.encoder = GNNStack(params=self.params)
        self.encoder = CapsNet(params=self.params)
        ...
        """After cnn, the ratio of length and width to the original size is reduced"""
